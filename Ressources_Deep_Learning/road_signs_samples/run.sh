rm keras_frcnn/*.pyc
rm results_imgs/*
#python train_frcnn.py --network=fcnet --parser=simple --num_epochs=12 --epoch_length=600 --path=/home/vincent/Téléchargements/github_roadsign_detection_FR_CNN/Traffic-Sign-Detection/GTSDB/TrainIJCNN2013/gt.txt --config_filename=fcnet_config.pickle --output_weight_path='./model_fcnet.hdf5'
python dummytest.py 
