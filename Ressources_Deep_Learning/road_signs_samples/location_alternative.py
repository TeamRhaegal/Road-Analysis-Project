"""
    code from the next link (github) : https://github.com/mbasilyan/Stop-Sign-Detection/blob/master/detectStopSigns.py
    
    Used to apply "brute force comparison" between a template (example image : e.g road signs) and a target image (e.g raspicam capture)
    and find the coordinates around recognised similarities, then crop interesting part of the image
